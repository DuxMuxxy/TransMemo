...
import dev.sergiobelda.compose.vectorize.images.icons.outlined.Pill
import dev.sergiobelda.compose.vectorize.images.icons.outlined.Vaccines
import dev.sergiobelda.compose.vectorize.images.icons.rounded.HeartCheck
...
import dev.sergiobelda.compose.vectorize.images.icons.rounded.Vaccines
...
object TransMemoIcons {
    ...
    val ProductsUnselected = Images.Icons.Outlined.Pill
    val Wellbeing = Images.Icons.Rounded.HeartCheck
