...
class GetNextCalendarEventsUseCaseTest {
    ...
    @Test
    fun computeNextEventsForMultipleProducts() =
        runTest {
            // Arrange
    ...
    @Test
    fun groupEventsByDateWhenMultipleEventsOnSameDate() =
        runTest {
            // Arrange
            val product = Product.default().copy(
                dosePerIntake = 1f,
    ...
    @Test
    fun setWarningToIntakesAfterEmptyEvent() =
        runTest {
            // Arrange
            val product = Product.default().copy(
                dosePerIntake = 1f,
    ...
    @Test
    fun setWarningToIntakesAfterExpirationEvent() =
        runTest {
            // Arrange
            val product = Product.default().copy(
                dosePerIntake = 1f,
    ...
    @Test
    fun doNotAddExpirationEvent_WhenExpirationIsZero() =
        runTest {
            // Arrange
            val product = Product.default().copy(
                dosePerIntake = 1f,
    ...
    @Test
    fun doNotAddEmptyEvent_WhenContainerIsAOneShot() =
        runTest {
            // Arrange
            val product = Product.default().copy(
                dosePerIntake = 1f,
