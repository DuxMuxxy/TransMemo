...
internal class LegacyDatabaseHelper(
    ...
    companion object {
        ...
        const val TAKES_COLUMN_IDPRODUIT = "ID_PRODUIT"
        const val TAKES_COLUMN_UNITE = "UNITE"
        const val TAKES_COLUMN_DOSE_PREVUE = "DOSE_PREVUE"
        const val TAKES_COLUMN_DOSE_REELLE = "DOSE_REELLE"
        const val TAKES_COLUMN_DATE_PREVUE = "DATE_PREVUE"
        const val TAKES_COLUMN_DATE_REELLE = "DATE_REELLE"
        const val TAKES_COLUMN_COTE_PREVU = "COTE_PREVU"
        const val TAKES_COLUMN_COTE_REEL = "COTE_REEL"
